...
class FileReceiverIf {
 public:
  ...
  virtual void GetTask(Task& _return, const ClientData& data) = 0;
...
typedef struct _FileReceiver_GetTask_args__isset {
  _FileReceiver_GetTask_args__isset() : data(false) {}
  bool data :1;
} _FileReceiver_GetTask_args__isset;
...
class FileReceiver_GetTask_args {
 public:
  ...
  _FileReceiver_GetTask_args__isset __isset;

  void __set_data(const ClientData& val);
...
class FileReceiverClient : virtual public FileReceiverIf {
 ...
 public:
  ...
  void GetTask(Task& _return, const ClientData& data);
  void send_GetTask(const ClientData& data);
...
class FileReceiverMultiface : virtual public FileReceiverIf {
 ...
 public:
  ...
  void GetTask(Task& _return, const ClientData& data) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->GetTask(_return, data);
    }
    ifaces_[i]->GetTask(_return, data);
    return;
  }
...
class FileReceiverConcurrentClient : virtual public FileReceiverIf {
 ...
 public:
  ...
  void GetTask(Task& _return, const ClientData& data);
  int32_t send_GetTask(const ClientData& data);
